  ...
  let productFeatures = [
    {
      ...
      description:
        "Gym Flex ensures all users have the information they need to train safely and train effectively.",
    ...
    {#each productFeatures as productFeature, index}
      <ProductCard {productFeature} {index}>
        ...
        {:else if index === 1}
          ...
          <span class="text-indigo-400 font-medium">routine</span> and consistency
        {:else}
